QUESTIONS = [
    {
        "text": "What is the total sum of Experimental Currency Units (ECU) to be divided between the two players in each round?",
        "options": ["A) 500 ECU", "B) 1000 ECU", "C) 750 ECU", "D) 1500 ECU"],
        "correct_answer": "B) 1000 ECU",
        "explanation": "Each round, the players are tasked with dividing a total of 1000 ECU between themselves."
    },
    {
    ...
    {
        "text": "Can players change their offer once it has been made?",
        "options": ["A) No, offers are final", "B) Yes, but only once", "C) Yes, as many times as they want", "D) Yes, but only if the other player agrees"],
        "correct_answer": "C) Yes, as many times as they want",
    ...
    },
    {
        ...
        "options": ["A) Yes, completely anonymous", "B) No, all decisions are public", "C) Only offers are anonymous", "D) Only decisions are anonymous"],
        "correct_answer": "A) Yes, completely anonymous",
