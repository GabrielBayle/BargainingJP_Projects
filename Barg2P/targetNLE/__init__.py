...
def compute_payoff(player: Player):
    ...
    if player.round_number == C.NUM_ROUNDS:
        ...
        txt_final = f"The round {player.NLE_paid_decision} has been randomly selected to be paid for this part. " \
        ...
        player.participant.vars["targetNLE"] = dict(txt_final=txt_final, payoff=paid_round.payoff, nle_paid_round=player.NLE_paid_decision)
