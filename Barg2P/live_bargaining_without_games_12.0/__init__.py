    ...
    def live_method(player: Player, data):
        ...
        if 'amount_player1' in data and 'amount_player2' in data:
            ...
            if data['type'] == 'stop_bargaining':
                default_share_player1 = C.DISAGREEMENT_PAYOFF
...
page_sequence = [Introduction, Instructions, InstructionsWaitMonitor, Bargain2, Results, WaitForGroup, NextAppWaitForAll]